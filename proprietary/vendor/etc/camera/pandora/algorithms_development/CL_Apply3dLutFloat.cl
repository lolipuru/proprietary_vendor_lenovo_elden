    ...
    float k)
{
    ...
    output_image[gid_x + gid_y * width] = Rout;
    output_image[gid_x + gid_y * width + datalength] = Gout;
    output_image[gid_x + gid_y * width + 2 * datalength] = Bout;
}

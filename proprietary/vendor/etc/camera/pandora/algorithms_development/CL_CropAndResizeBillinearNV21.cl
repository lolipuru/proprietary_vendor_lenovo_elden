    ...
    int stride)
{
    ...
    uchar pixel1 = srcPtr[y1 * stride + x1];
    uchar pixel2 = srcPtr[y1 * stride + x2];
    uchar pixel3 = srcPtr[y2 * stride + x1];
    uchar pixel4 = srcPtr[y2 * stride + x2];
    ...
    int stride)
{
    ...
    uchar pixel1 = srcVUPtr[y1 * stride + x1];
    uchar pixel2 = srcVUPtr[y1 * stride + x2];
    uchar pixel3 = srcVUPtr[y2 * stride + x1];
    uchar pixel4 = srcVUPtr[y2 * stride + x2];
    float top_pixel = pixel1 * (1 - x_diff) + pixel2 * x_diff;
    float bottom_pixel = pixel3 * (1 - x_diff) + pixel4 * x_diff;
...
__kernel void CropAndResizeBillinearNV21(

// CL Kernel Source Code for SketchCvt Algorithm
// Version 1.0.0
constant int gSketchLut[256] =
{
...
__kernel void SketchCvt(
    __global unsigned char *pInputYuv,
    __global float *pOutputGRAY,
    __global float *pOutputInvGRAY)
{
    ...
    pOutputGRAY[index] =
        pInputYuv[index] * (1 - weight) + (float)(gSketchLut[pInputYuv[index]]) * weight;
    pOutputInvGRAY[index] = 255 - pOutputGRAY[index];
}